    ...
    <>
      ...
      <div className="flex flex-col h-screen">
        ...
        <a href="https://www.producthunt.com/posts/sanatanadharma-xyz?utm_source=badge-featured&utm_medium=badge&utm_souce=badge-sanatanadharma-xyz" target="_blank" rel="noopener noreferrer">
          <img src="https://api.producthunt.com/widgets/embed-image/v1/featured.svg?post_id=416280&theme=light" alt="SanatanaDharma.xyz - Sanatana Dharma Chatbot: Revealing Our Heritage 🕉️ | Product Hunt" style={{ width: '250px', height: '54px' }} width="250" height="54" />
        </a>
        <Footer />
      </div>
      <Analytics />
